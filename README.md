...
| 이정현 | 탐색적 분석, 데이터 전처리, 전체 모델링 사전 학습 모데 비교, FPN 모델링 | https://github.com/leejunghyunA |
| 윤정준 | 탐색적 분석, 데이터 전처리, 전체 모델링 사전 학습 모데 비교 | |
| 진청아 | 탐색적 분석, 데이터 전처리, 전체 모델링 사전 학습 모데 비교 | https://github.com/risa1796 |
